...
console.log(list);
    return (
      <div className="side-container md:mt-32 mt-10">
        <h1 className="text-center mb-2 text-3xl font-bold">Job Category List</h1>
        ...
        <div className="md:flex  items-center justify-center justify-between mt-8">
          {list.map((categorie, idx) => (
            <div
              ...
              key={idx}
            >
              <img className="h-28 mt-8" src={categorie.logo} alt="" />
